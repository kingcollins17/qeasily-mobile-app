      ...
      child: Row(
        children: [
          Container(
            ...
            child: Text(quiz.questionsAsInt.length.toString(), style: big00),
          ),
          spacer(x: 15),
          Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            Row(
              children: [
                ...List.generate(
                  ...
                  (index) => Icon(Icons.star, size: 12, color: deepSaffron),
                )
              ],
            ),
            spacer(),
            Row(
              children: [
                ...
                spacer(),
                Text('${Duration(seconds: quiz.duration).inMinutes} Minutes',
                    style: xs01),
              ],
            )
          ]),
